...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PF4     ------> ADC3_IN14
    */
    HAL_GPIO_DeInit(AUX_IO_GPIO_Port, AUX_IO_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB8     ------> I2C1_SCL
    */
    HAL_GPIO_DeInit(ENV_SD_GPIO_Port, ENV_SD_Pin);

    HAL_GPIO_DeInit(ENV_CK_GPIO_Port, ENV_CK_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(SMBDATA_GPIO_Port, SMBDATA_Pin);

    HAL_GPIO_DeInit(SMBCLK_GPIO_Port, SMBCLK_Pin);
...
void HAL_I2S_MspDeInit(I2S_HandleTypeDef* hi2s)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PI0     ------> I2S2_WS
    */
    HAL_GPIO_DeInit(GPIOI, MIC_SD_Pin|MIC_CK_Pin|GPIO_PIN_0);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, IOLINK_COM_TX_Pin|IOLINK_COM_RX_Pin);
