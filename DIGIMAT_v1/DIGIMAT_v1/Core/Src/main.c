...
LSM6DSL_IO_t bus_accelerometro;
LSM6DSL_Object_t accelerometro;
LSM6DSL_Axes_t misure_accelerometro;

uint8_t buss_da_inviare_su_uart [128];
uint8_t start_msg[]="Inizio acquisizioni \r \n";
